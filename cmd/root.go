...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kubectl-topology.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".node-topology" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".node-topology")
	}
